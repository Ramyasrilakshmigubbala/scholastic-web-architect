...
import { BookOpen, Users, ChemicalElement, Language, Calculator, Microscope, PenTool, HeartHandshake } from 'lucide-react';
...
const departments = [
  ...
  },
  {
    ...
    icon: <ChemicalElement className="h-10 w-10 text-primary" />,
